...
let AtStrategy = class AtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, constant_1.ENV.JWT_ACCESS_TOKEN) {
    constructor(config) {
        super({
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromAuthHeaderAsBearerToken(),
            secretOrKey: constant_1.ENV.JWT_AT_SECRET,
        });
    }
    validate(payload) {
        console.log({ payload });
